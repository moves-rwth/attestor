...
public class PredicateAnalyzer {
    ...
    private final ExtermalValue<RelativeIndex> extremalValue;
    ...
    public PredicateAnalyzer(Program program, StateSpace stateSpace,
                             ExtermalValue<? extends RelativeIndex> extremalValue,
        ...
        this.extremalValue = (ExtermalValue<RelativeIndex>) extremalValue;
